...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo U('Center/index');?>" class="navbar-link">首页</a></p>
            </div>
            <div class="col-xs-3">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-9">
                ...
                <span class="text-danger pull-right"><a class="ajax-get" href="<?php echo U('Mine/score');?>">签到</a></span>
            </div>
        </div>
        <div class="blank"></div>
