...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        ...
        <div class="container-fluid">
            <div class="blank" ></div>
            <h3 class="noticeDetailTitle" ><strong>标题:<?php echo ($article["title"]); ?></strong></h3>
            <div class="noticeDetailInfo">发布者:<?php echo ($article["nickname"]); ?></div>
            <div class="noticeDetailInfo">发布时间：<?php echo (date("Y-m-d H:i:s",$article["create_time"])); ?></div>
