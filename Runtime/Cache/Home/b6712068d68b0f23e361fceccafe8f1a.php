...
<div class="main">
    ...
    <div class="container-fluid">
        <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><div class="row noticeList">
            <a href="<?php echo U('Notice/detail','id='.$article['id']);?>">
            <div class="col-xs-2">
                ...
                <div class="col-xs-10">
                    ...
                    <p class="intro"><?php echo ($article["content"]); ?></p>
