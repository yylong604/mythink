		...
		<table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($repair["num"]); ?></td>
						<td><?php echo ($repair["username"]); ?></td>
						...
						<!--<td><?php echo ($repair["url"]); ?></td>-->
                        <!--<td><?php echo ($repair["sort"]); ?></td>-->
						<td>
							<a class="btn btn-info ajax-get" href="/admin.php/repair/changestatus/id/22/status/1.html">接受处理</a>
							<a title="查看详情" href="<?php echo U('detail?id='.$repair['id'].'&pid='.$pid);?>">查看详情</a>
